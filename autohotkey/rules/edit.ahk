...
; - herdr:    1..8 (Ctrl+Alt+1..8)。9/0 は main.ahk の AHK 管理用
; ==============================================================================
...
; --- 8. herdr focus_agent (無変換 + 1..8 -> Ctrl+Alt+1..8) ---
vk1D & 1::Send("^!1")
vk1D & 2::Send("^!2")
vk1D & 5::Send("^!5")
vk1D & 6::Send("^!6")
vk1D & 7::Send("^!7")
vk1D & 8::Send("^!8")
; 3/4 は上のスクショ節で Shift/Ctrl なし時 ^!3 / ^!4 を送信

; --- 9. 括弧囲み (Shift+コロン で ** 囲み。コロン単体は改行) ---
